...
public class latihan18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan18);
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent beach = new  Intent(latihan18.this, MainActivity.class);
                startActivity(beach);
            }
        });
        ...
        btn_restart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beach = new  Intent(latihan18.this, soal_latihan.class);
                startActivity(beach);
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beach = new  Intent(latihan18.this, latihan19.class);
                startActivity(beach);
            }
        });
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Next",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        Intent beach = new  Intent(latihan18.this, bahas18.class);
                        startActivity(beach);
                    }
                })
