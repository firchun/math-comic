...
public class latihan17 extends AppCompatActivity {

    Button btn_next,btn_c,btn_a,btn_b,btn_d;
    ImageButton btn_home,btn_restart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_latihan17);
        ...
        final MediaPlayer jawaban4 = MediaPlayer.create(this, R.raw.true2);
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent beach = new  Intent(latihan17.this, MainActivity.class);
                startActivity(beach);
            }
        });
        ...
        btn_restart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beach = new  Intent(latihan17.this, soal_latihan.class);
                startActivity(beach);
            }
        });
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beach = new  Intent(latihan17.this, latihan18.class);
                startActivity(beach);
            }
        });
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Next",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        Intent beach = new  Intent(latihan17.this, bahas17.class);
                        startActivity(beach);
                    }
                })
