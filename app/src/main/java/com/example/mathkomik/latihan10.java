...
public class latihan10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beach = new  Intent(latihan10.this, latihan11.class);
                startActivity(beach);
            }
        });
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Next",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        Intent beach = new  Intent(latihan10.this, bahas10.class);
                        startActivity(beach);
                    }
                })
    ...
    private void back_home(){
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yaa",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        // jika tombol diklik, maka akan menutup activity ini
                        Intent beach = new  Intent(latihan10.this, MainActivity.class);
                        startActivity(beach);
                    }
                })
    ...
    private void back_start(){
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Yaa",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        // jika tombol diklik, maka akan menutup activity ini
                        Intent beach = new  Intent(latihan10.this, soal_latihan.class);
                        startActivity(beach);
                    }
                })
                .setNegativeButton("Tidak",new DialogInterface.OnClickListener() {
